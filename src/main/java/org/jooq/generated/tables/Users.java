...
public class Users extends TableImpl<UsersRecord> {
     ...
     */
    public final TableField<UsersRecord, Integer> UID = createField(DSL.name("uid"), SQLDataType.INTEGER.nullable(false).identity(true), this, "");
    ...
    /**
     * The column <code>public.users.auth</code>.
     */
    public final TableField<UsersRecord, String> AUTH = createField(DSL.name("auth"), SQLDataType.VARCHAR, this, "");
